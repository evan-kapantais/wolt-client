          ...
          <div className="footer-top__content">
            <section className="footer-section__wolt">
              ...
              <p>
                ...
                χώρες της Ευρώπης και Ασίας. Ιδρύθηκε στη Φινλανδία το 2014 και
                ήδη λειτουργεί σε 23 χώρες και πάνω από 150 πόλεις. Έχει στο
                ενεργητικό της πάνω από 30 εκατομμύρια χρήστες, 40.000
