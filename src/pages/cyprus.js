...
const IndexPage = ({ data }) => {
  ...
  // Sourced content
  const topicsOrder = data.strapiCyTopicsOrder.order.split("\n");
  const newsItems = data.allStrapiCyNewsItem.edges;
...
export const data = graphql`
  query {
    allStrapiCyTopic(sort: { fields: strapiId, order: ASC }) {
      edges {
        node {
          title
          emoji
